...
<body>
    <div class="container">
        ...
        <div class="row">
            <form id="form" class="form-horizontal">
                <div class="form-group">
                    <div class="col-sm-8">
                        <%--<input class="form-control" type="text" id="wadoURL" placeholder="Enter WADO URL"  value="https://raw.githubusercontent.com/abstech2019/AbsTech/master/AbsTech/Images/1.2.392.200036.9125.4.0.437218728.162610028.870646074.dcm">--%>
                        <input type="hidden" id="wadoURL1" value="https://raw.githubusercontent.com/abstech2019/AbsTech/master/AbsTech/Images/1.2.392.200036.9125.4.0.437218728.162610028.870646074.dcm" />
                        <input type="hidden" id="wadoURL2" value="https://raw.githubusercontent.com/abstech2019/AbsTech/master/AbsTech/Images/1.2.392.200036.9125.9.0.253425975.167790607.3479030065.dcm" />
                ...
                <div class="form-group">
                    <div class="col-sm-2">
                        <input type="button" class="btn" id="btnRotate" value="Rotate 90" />
                    </div>
                    <div class="col-sm-2">
                        <input type="button" class="btn" id="btnAntiRotate" value="Rotate -90" />
                    </div>
                    <div class="col-sm-2">
                        <input type="button" class="btn" id="btnHFlip" value="HFlip" />
                    </div>
                    <div class="col-sm-2">
                        <input type="button" class="btn" id="btnVFlip" value="VFlip" />
                    </div>
                    <div class="col-sm-2">
                        <input type="button" class="btn" id="btnReset" value="Reset" />
                    </div>
                    <div class="col-sm-2">
                        <input type="button" class="btn" id="btnDetail" data-toggle="modal" data-target="#myModal" value="Details" />
                    </div>
                </div>
            </form>
        </div>
        <br />
        <div class="row">
            <div class="col-md-6" id="dvFirstDicom">
            ...
            <div class="col-md-6" id="dvSecondDicom">
                <div style="width: 512px; height: 512px; position: relative; color: white; display: inline-block; border-style: solid; border-color: black;"
                    oncontextmenu="return false"
                    class='disable-selection noIbar'
                    unselectable='on'
...
<script>
    ...
    function downloadAndView() {
        let url = document.getElementById('wadoURL1').value;
        ...
        url = "";
        url = document.getElementById('wadoURL2').value;
        url = "wadouri:" + url;
    ...
    document.getElementById('btnHFlip').addEventListener('click', function (e) {
        const viewport = cornerstone.getViewport(element);
        viewport.hflip = !viewport.hflip;
        cornerstone.setViewport(element, viewport);
    });
    document.getElementById('btnVFlip').addEventListener('click', function (e) {
        const viewport = cornerstone.getViewport(element);
    ...
    $("#dvFirstDicom").mouseover(function(){
        cornerstone.enable(element);
    });
    $("#dvSecondDicom").mouseover(function(){
        cornerstone.enable(element2);
    });
</script>
</html>
